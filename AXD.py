...
# code by ZANI CH.
# my facebook ( https://www.facebook.com/AZAN X. )
...
def logo():
 ...
 ╚═╝     ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝\n{N} ▌│█║▌║▌║META FACEBOOK METHOD║▌║▌║█│▌{N} """)
    print("╔════════════════════════════════════════╗")
    print(f"║{P}[{H}•{P}] Author    : AZA ALI                  {N}║")
    print(f"║{P}[{H}•{P}] Whatsapp  : +92316545679           {N}║")
    print(f"║{P}[{H}•{P}] Github    : github.com/MR-AZAN/AXD{N}  ║")
    print(f"║{P}[{H}•{P}] SC Status : BRAND {H}Premium{P}     {N}║")
    print(f"║{P}[{H}•{P}] Support   : 64bit                   {N}║")
    print(f"║{P}[{H}•{P}] Network   : {H}ANY{N}, {H}NET{N}, {H}WORK{N}         ║")
